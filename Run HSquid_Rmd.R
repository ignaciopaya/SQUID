...
# Run  
rmarkdown::render(input="SC12 WP HSquid_HTML.Rmd",  output_format="html_document")
#rmarkdown::render(input="SC12 WP HSquid_WORD.Rmd",  output_format="word_document")
#rmarkdown::render(input="HSquid_PDF.Rmd",  output_format="pdf_document") 
# rename copy ouput to results
file.copy(paste("SC12-WP-HSquid_HTML.html",sep=""),paste("SC12-WP-HSquid__HTML_",case,".html",sep=""),overwrite = T)
#file.copy(paste("HSquid_WORD.docx",sep=""),paste("HSquid_WORD_",case,".docx",sepcase#file.copy(paste("HSquid_WORD.docx",sep=""),paste("HSquid_WORD_",case,".docx",sep=""),overwrite = T)
