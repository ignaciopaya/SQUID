...
# ------------------------------------------------------------------------
#   Ignacio Payá, april 2024
# -----------------------------------------------------------------------
pars=read.table("HSquid_Par_1.csv",sep=";",header=TRUE,skip=1)  
cases=3
...
if (case>1) {pars=rbind(pars,read.table(paste("HSquid_Par_",case,".csv",sep=""),sep=";",header=TRUE,skip=1))}  
# Run  
rmarkdown::render(input="SC11 WP HSquid_HTML.Rmd",  output_format="html_document")
#rmarkdown::render(input="HSquid_WORD.Rmd",  output_format="word_document")
#rmarkdown::render(input="HSquid_PDF.Rmd",  output_format="pdf_document") 
# rename copy ouput to results
file.copy(paste("HSquid_HTML.html",sep=""),paste("HSquid__HTML_",case,".html",sep=""),overwrite = T)
#file.copy(paste("HSquid_WORD.docx",sep=""),paste("HSquid_WORD_",case,".docx",sep=""),overwrite = T)
#file.copy(paste("HSquid_PDF.pdf",sep=""),paste("HSquid_PDF_",case,".pdf",sep=""),overwrite = T)
